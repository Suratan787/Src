...
{
    internal class ModelConfiguration : IEntityTypeConfiguration<RichnessSoft.Entity.Model.Models>
    {
        public void Configure(EntityTypeBuilder<RichnessSoft.Entity.Model.Models> builder)
        {
            ...
            builder.HasOne(p => p.Company).WithMany(p => p.Modelss).HasForeignKey(e => e.companyid).OnDelete(DeleteBehavior.Restrict);
        }
    }
}