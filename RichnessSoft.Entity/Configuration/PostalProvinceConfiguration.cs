...
{
    internal class PostalProvinceConfiguration : IEntityTypeConfiguration<PostalProvince>
    {
        public void Configure(EntityTypeBuilder<PostalProvince> builder)
        {
            builder.ToTable("postalprovince");
            ...
            builder.Property(e => e.name2).HasColumnType("varchar(50)");
