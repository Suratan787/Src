...
namespace RichnessSoft.Common.Appenders
{
    public static class Configuration
    {
        ...
        public static IAppender CreateAdoNetAppender(string connectionString)
        {
            AdoNetAppender appender = new AdoNetAppender()
            {
                ...
                CommandText = "INSERT INTO Logs ([Date],[Thread],[Level],[Logger],[Message],[Exception]) VALUES (@log_date, @thread, @log_level, @logger, @message, @exception)"
            };
